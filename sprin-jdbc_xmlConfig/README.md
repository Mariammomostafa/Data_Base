...
- This is xml-based configuration project 
...
- uses spring built in RowMapper (BeanPropertyRowMapper)  to convert a row into a new instance of the specified mapped target class
### Prerequisites
- Java 17
